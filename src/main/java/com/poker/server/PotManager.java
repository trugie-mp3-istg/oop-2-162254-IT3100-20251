...
/**
 * PotManager handles side pot calculations and distribution. Manages main pot
 * and side pots when players go all-in.
 */
public class PotManager {
    ...
    public void handleAllIn(Server player, int allInAmount) {
        ...
        for (int threshold : betAmounts) {
            ...
            for (Server p : activePlayers) {
                if (p.isFolded) {
                    continue; // Folded players don't contribute or win
                }
