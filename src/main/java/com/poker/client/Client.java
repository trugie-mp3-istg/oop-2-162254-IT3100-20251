...
public class Client{
    ...
    private void parseData(String data){
        ...
        switch (message[0]){
            ...
            case "card":
                tc.message.setText(" ");
                tc.card1.setImage(new Image("/graphic/" + message[1] + ".png"));
                tc.card2.setImage(new Image("/graphic/" + message[2] + ".png"));
                break;
            ...
            case "flop":
                tc.cc1.setImage(new Image("/graphic/" + message[1] + ".png"));
                tc.cc2.setImage(new Image("/graphic/" + message[2] + ".png"));
                tc.cc3.setImage(new Image("/graphic/" + message[3] + ".png"));
                break;

            case "turn":
                tc.cc4.setImage(new Image("/graphic/" + message[1] + ".png"));
                break;

            case "river":
                tc.cc5.setImage(new Image("/graphic/" + message[1] + ".png"));
                break;
...
//                    }
            ...
            case "cardReset":
                ...
                tc.cc1.setImage(new Image("/graphic/download.jpg"));
                tc.cc2.setImage(new Image("/graphic/download.jpg"));
                tc.cc3.setImage(new Image("/graphic/download.jpg"));
                tc.cc4.setImage(new Image("/graphic/download.jpg"));
                tc.cc5.setImage(new Image("/graphic/download.jpg"));

                tc.card21.setImage(new Image("/graphic/download.jpg"));
                tc.card22.setImage(new Image("/graphic/download.jpg"));
                tc.card31.setImage(new Image("/graphic/download.jpg"));
                tc.card32.setImage(new Image("/graphic/download.jpg"));
                tc.card41.setImage(new Image("/graphic/download.jpg"));
            ...
            case "cardshow":
                for(int i = 0;i<players.size();i++){
                    ...
                    if(tc.p2.getText().equals(message[1])){
                        tc.card21.setImage(new Image("/graphic/" + message[2] + ".png"));
                        tc.card22.setImage(new Image("/graphic/" + message[3] + ".png"));
                    }
                    else  if(tc.p3.getText().equals(message[1])){
                        tc.card31.setImage(new Image("/graphic/" + message[2] + ".png"));
                        tc.card32.setImage(new Image("/graphic/" + message[3] + ".png"));
                    }
                    else if(tc.p4.getText().equals(message[1])){
                        tc.card41.setImage(new Image("/graphic/" + message[2] + ".png"));
                        tc.card42.setImage(new Image("/graphic/" + message[3] + ".png"));
                    }
                    else if(tc.p5.getText().equals(message[1])){
                        tc.card51.setImage(new Image("/graphic/" + message[2] + ".png"));
                        tc.card52.setImage(new Image("/graphic/" + message[3] + ".png"));
                    }
    ...
    private void openTable(){
        ...
        try {
            ...
            tc.circle.setFill(new ImagePattern(new Image("/graphic/blackChip2.jpg")));
            tc.pot1.setFill(new ImagePattern(new Image("/graphic/redChip.png")));
            tc.pot2.setFill(new ImagePattern(new Image("/graphic/redChip.png")));
            tc.pot3.setFill(new ImagePattern(new Image("/graphic/redChip.png")));
            tc.pot4.setFill(new ImagePattern(new Image("/graphic/redChip.png")));
            tc.pot5.setFill(new ImagePattern(new Image("/graphic/redChip.png")));
            tc.pot6.setFill(new ImagePattern(new Image("/graphic/redChip.png")));
            tc.avatar1.setFill(new ImagePattern(new Image("/graphic/face2.jpg")));
        }
        catch (IOException e){
            e.printStackTrace();
